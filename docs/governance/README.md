...
3. Plan v1.1.1 — Canonical Parallel vNext Execution Override.
4. Plan v1.1 — Parallel vNext Build.
5. Still-applicable portions of Etap 6.
6. Still-applicable portions of Etap 5.
7. Latest verified Execution Handoff — evidence/status, not governance authority.
