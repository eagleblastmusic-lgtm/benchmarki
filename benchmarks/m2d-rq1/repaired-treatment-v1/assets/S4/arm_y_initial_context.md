...
visible_unknowns: 0
visible_omissions: 1
claim_classes: FACT=7, INFERENCE=0, ASSUMPTION=0, HYPOTHESIS=0
included source subjects: 7
...
- FACT / EXACT_SOURCE: committed source evidence for bdb_vnext/composition.py
- FACT / EXACT_SOURCE: committed source evidence for docs/m2b-vnext-typed-context-transport.md
